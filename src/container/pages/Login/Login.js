...
const Login = () => {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(login(enteredEmail, enteredPassword, handlingError, navigate));
  ...
  return (
    ...
    >
      <form onSubmit={handleSubmit}>
        {errorLogin && (
          <div
            className={`text-center absolute bg-[#BE3144] text-white  w-2/4  top-1/5 left-1/4 p-6 rounded `}
          >
            <p className="text-sm mb-3"> User not found</p>
        ...
        <div className="flex justify-center mt-7 -ml-1">
          <Button>Login</Button>
        </div>
